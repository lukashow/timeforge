...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_timetable_entries",
    "indexes": [
      "CREATE INDEX idx_timetable_generation ON timetable_entries (generation_id)",
  ...
  const collection = app.findCollectionByNameOrId("pbc_timetable_entries");
